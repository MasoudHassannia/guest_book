...
public class GuestbookEntryAssetRenderer
	extends BaseJSPAssetRenderer<GuestbookEntry> {

	public GuestbookEntryAssetRenderer(
	...
	public String getURLViewInContext(
		...
		try {
			long plid = PortalUtil.getPlidFromPortletId(
				_entry.getGroupId(), GuestbookPortletKeys.GUESTBOOK);
			...
			if (plid == LayoutConstants.DEFAULT_PLID) {
				...
				portletURL = PortletURLFactoryUtil.create(
					liferayPortletRequest, GuestbookPortletKeys.GUESTBOOK, plid,
					PortletRequest.RENDER_PHASE);
			}
	...
	private final ModelResourcePermission<GuestbookEntry>
